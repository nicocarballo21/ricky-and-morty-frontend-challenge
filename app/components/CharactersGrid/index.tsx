...
].slice(0, 10) as Character[];

const CharactersGrid = () => {
  return (
    <div
      className={`grid rounded-lg p-3 grid-cols-1 sm:grid-cols-2 max-h-[${CARD_SIZE}px] place-items-center md:grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-2 w-full aspect-square`}
    >
      {array.map(character => (
